...
-- Requires the leaders table to be pre-seeded (companionships.leader_id FK).
-- 6 solo companionships have a NULL companion2_name; schema.sql makes that column nullable.
-- =============================================================
