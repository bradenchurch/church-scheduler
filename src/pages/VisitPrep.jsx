...
export default function VisitPrep() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      {/* Add to my calendar — a one-off .ics for just this visit */}
      <a
        href={`/api/visit/${encodeURIComponent(bookingId)}/ics`}
        download
        className="mt-4 flex min-h-[48px] w-full items-center justify-center gap-2 rounded-2xl bg-sage px-5 text-sm font-semibold text-white shadow-sm transition-opacity hover:opacity-90"
      >
        <svg
          width="18"
          height="18"
